...
bg = pygame.transform.scale(pygame.image.load('background.png'), (HEIGHT, WIDTH))
bg_x1 = 0
bg_x2 = bg.get_width()
bg_move = 3
...
player_rect = player.get_rect(center=(50,WIDTH//2))
# player_speed = [1, 1]
...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(0, WIDTH - bonus_size[1]), 0, *bonus_size)
...
while playing:
    ...
    main_display.blit(FONT.render(str(score), True, COLOR_BLACK), (HEIGHT-50, 20))
